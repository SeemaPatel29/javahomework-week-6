Feature: Demo Nopcommerce's topmenu acceptance criteria
   ...
   Background: User is on given page
   ...
   Scenario: Verify that user can see the Books category page with filters
   ...
   Given     User is on Book Category
   When      User is on Book Category
   And       Check 'List' tab is present
   Then      'List' tab is available on Book Category page

   Scenario:  Verify thst User can see 'Name A to Z' selection is present in 'Sort by' filter
   Given      User is on Books Category page
   When       User is on Books Category page
   ...
   When      User is on Books Category page
   And       Click on 'Sort by' Filter
   And       Check that 'Name: A to A' is first option in order
   Then      'Name: Ato Z' is first option in order

   Scenario: Verify that user can see 'Name: A to A' filter is functioning as
             expected (Note: Products are filtered in alphabetical order)
   Given     User is on Books category page
   When      User is on Books Category page
   And       Click on 'Sort by' Filter
